  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-6">
        <SectionTitle eyebrow="Nossa história" title="Isaías 41:20" />
        ...
        <div className="grid gap-12 md:gap-16 md:grid-cols-2 items-center">
          ...
          <div className="order-1 md:order-2 space-y-6 text-texto/80 leading-relaxed text-base md:text-xl">
            ...
            <p>
              Nossa história começou de forma natural, quase despretensiosa, mas
              já trazia em si algo maior: Deus escrevendo cada detalhe, mesmo
              quando a gente ainda não entendia.
            </p>
            <p>
              Agora, seguimos construindo juntos — com propósito, fé e a certeza
              de que esse é só o começo.
            </p>
          </div>
        </div>
      </div>
